...
export OPENAI_API_KEY=OPENAI_API_KEY--replace-with-your-key
export OPENAI_ORG_ID=org-replace-with-your-org-id
export AZURE_OPENAI_API_KEY=AZURE_OPENAI_API_KEY--replace-with-your-key
